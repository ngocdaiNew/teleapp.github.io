...
window.blazor_boot_dll_min = urlParams.has("dll_min") ? parseInt(urlParams.get("dll_min")) : 10;
window.blazor_boot_dll_val = urlParams.has("dll_val") ? parseInt(urlParams.get("dll_val")) : 50;
window.blazor_boot_dll_msg = urlParams.has("dll_msg") ? urlParams.get("dll_msg") : "Tải trang...";
